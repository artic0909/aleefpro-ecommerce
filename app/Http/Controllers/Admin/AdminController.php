...
class AdminController extends Controller
{
    ...
    public function addProduct(Request $request)
    {
        try {
            ...
            $request->validate([
                ...
                'images.*' => 'nullable|image|mimes:jpeg,png,jpg,webp|max:7048',
    ...
    public function editProduct(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'images.*' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:7048',
            'front_customize' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:7048',
            'back_customize' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:7048',
            'size_chart_image' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:7048',
            'sizes' => 'nullable|string',
            'colors' => 'nullable|string',
            'actual_price' => 'required|numeric',
            'selling_price' => 'required|numeric',
