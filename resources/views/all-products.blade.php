...
<head>
    ...
    <!--SEO-->
    <!-- SEO Meta Tags -->
    <meta name="description" content="Discover premium quality {{ $subCategory->sub_category_name }} in the {{ $mainCategory->main_category_name }} category at Aleef Pro. Shop now for the best prices and quality.">
    <meta name="keywords" content="{{ $subCategory->sub_category_name }}, {{ $mainCategory->main_category_name }}, Buy {{ $subCategory->sub_category_name }}, Aleef Pro products, Online shopping {{ $mainCategory->main_category_name }}">
    <meta name="author" content="Aleef Pro">
    <link rel="canonical" href="{{ url()->current() }}" />

    <!-- Open Graph / Facebook -->
    <meta property="og:title" content="{{ $mainCategory->main_category_name }} | {{ $subCategory->sub_category_name }} - Aleef Pro">
    <meta property="og:description" content="Find top deals on {{ $subCategory->sub_category_name }} under the {{ $mainCategory->main_category_name }} section. Fast delivery and best quality at Aleef Pro.">
    ...
    <meta name="twitter:title" content="{{ $mainCategory->main_category_name }} | {{ $subCategory->sub_category_name }} - Aleef Pro">
    <meta name="twitter:description" content="Shop the latest {{ $subCategory->sub_category_name }} in {{ $mainCategory->main_category_name }} online. Premium products at Aleef Pro.">
