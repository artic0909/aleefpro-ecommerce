...
<head>
    ...
    <meta name="title" content="About Aleef Pro - {{ Str::limit(strip_tags($about->moto), 60) }}">
    <meta name="description" content="{{ Str::limit(strip_tags($about->vision), 150) }}">
    <meta name="keywords" content="About Aleef Pro, Aleef Vision, Aleef Motto, Aleef Company, Online Shopping, Trusted Store">
    @endforeach
    ...
    <style>
        ...
        /* Optional: Reduce padding/margin to align better */
