...
<head>
    ...
    <!-- SEO -->
    <!-- Primary Meta Tags -->
    <meta name="title" content="{{ $blog->blog_name }}">
    <meta name="description" content="{{ $blog->meta_description ?? Str::limit(strip_tags($blog->description), 160) }}">
    <meta name="keywords" content="{{ $blog->meta_keywords ?? 'Aleef Pro, Blog, Article' }}">
    <meta name="author" content="{{ $blog->author ?? 'Aleef Pro' }}">
    ...
    <meta property="og:title" content="{{ $blog->meta_title ?? $blog->blog_name }}">
    ...
    <meta name="twitter:title" content="{{ $blog->meta_title ?? $blog->blog_name }}">
