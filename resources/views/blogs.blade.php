...
<head>
    ...
    <!-- SEO -->
    <!-- Primary Meta Tags -->
    <meta name="title" content="{{'Aleef Pro Blogs | Tips, News & Updates' }}">
    <meta name="description" content="{{ $meta_description ?? 'Read the latest blogs from Aleef Pro on trends, tips, and news related to our products and services.' }}">
    <meta name="keywords" content="Aleef Pro, Blogs, Product Updates, News, Tips, Articles, {{ $meta_keywords ?? '' }}">
    ...
    <meta property="og:title" content="{{ $meta_title ?? 'Aleef Pro Blogs' }}">
    <meta property="og:description" content="{{ $meta_description ?? 'Check out the latest updates, news and blog posts from Aleef Pro.' }}">
    <meta property="og:image" content="{{ asset('img/logo1.webp') }}">

    <!-- Twitter -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:url" content="{{ url()->current() }}">
    <meta name="twitter:title" content="{{ $meta_title ?? 'Aleef Pro Blogs' }}">
    <meta name="twitter:description" content="{{ $meta_description ?? 'Latest news, tips and blogs from Aleef Pro.' }}">
