...
<body>
    ...
    <!-- Delivered Template -->
    <div id="delivered-template" class="email-container">
        <div class="header">
        ...
        <div class="content">
            <div class="shipment-status status-delivered">
                <div class="status-icon status-icon-delivered">✓</div>
                <div>
                    <div class="status-text">Delivered Successfully</div>
                    <div class="status-subtext">Your package was delivered to your location</div>
                    <div class="status-subtext">Address: {{ $order->customer->address }}</div>
                </div>
            </div>
