                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollDescriptionModal{{ $enquiry->id }}" class="btn btn-primary">Details</button></td>

                                                <td>
                                                    <form action="{{ route('admin.product-enquiry.remark', $enquiry->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                ...
                                                <td>
                                                    <a href="tel:{{ $enquiry->customer_mobile }}" class="btn btn-warning">Call</a>
                                                </td>
                                                <td>
                                                    <a href="mailto:{{ $enquiry->customer_email }}" class="btn btn-success">Mail</a>
                                                </td>
                                                <td>
