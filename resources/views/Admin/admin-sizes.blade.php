        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-active" href="/admin/sizes">
                            <i class="icon-paper menu-icon active-color"></i>
                            <span class="menu-title active-color">Add Sizes</span>
                        </a>
                    </li>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <div class="card col-12">
                            <div class="card-body">
                                <h4 class="card-title">Add Product Sizes</h4>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $size->size }}</td>
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollEditModal{{ $size->id }}" class="btn btn-success">Edit</button></td>
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollDeleteModal{{ $size->id }}" class="btn btn-danger">Delete</button></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                ...
                <div class="modal fade" id="scrollAddModal" tabindex="-1" aria-labelledby="scrollAddModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.size.store')}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-header">
                                <h5 class="modal-title" id="scrollAddModalLabel">Add Product Size</h5>
                ...
                <!-- Edit Modal -->
                @foreach($sizes as $size)
                <div class="modal fade" id="scrollEditModal{{ $size->id }}" tabindex="-1" aria-labelledby="scrollEditModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.size.edit', $size->id)}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-header">
                                <h5 class="modal-title" id="scrollEditModalLabel{{ $size->id }}">Edit Product Size</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div>
                                    <label for="size" class="form-label">Size<span class="text-danger">*</span></label>
                                    <input type="text" name="size" id="size" class="form-control" placeholder="Enter Size" value="{{ $size->size }}" required>
                ...
                <!-- Delete Modal -->
                @foreach($sizes as $size)
                <div class="modal fade" id="scrollDeleteModal{{ $size->id }}" tabindex="-1" aria-labelledby="scrollDeleteModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.size.delete', $size->id)}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf

                            <div class="modal-body">
                                <div>
                                    <h3 class="text-danger" style="text-transform: capitalize;">You want to this {{ $size->size }} ?</h3>
                                </div>
                            </div>
                            <div class="modal-footer">
