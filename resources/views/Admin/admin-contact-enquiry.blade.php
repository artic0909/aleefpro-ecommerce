                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollDescriptionModal{{ $enquiry->id }}" class="btn btn-warning">Enquiry</button></td>
                                                <td>
                                                    <form action="{{ route('admin.contact-enquiry.remark', $enquiry->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <button type="submit" class="btn btn-secondary" style="text-transform: capitalize;" {{ $enquiry->remark === 'read' ? 'disabled' : '' }}>
                                                            {{ $enquiry->remark }}
                                                        </button>
                                                    </form>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="mailto:{{ $enquiry->email }}" class="btn btn-success">Mail</a>
                                                </td>
                                                <td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div>
                                    ...
                                    <h4 class="mb-3 text-Success">Subject:</h4>
                                ...
                                <div class="mt-3">
                                    ...
                                    <h4 class="mb-3 text-Success">Message:</h4>
