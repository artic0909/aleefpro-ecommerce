                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>{{ $cartEnquiry->enquiry_date }}</td>
                                                ...
                                                <td>
                                                    <form action="{{ route('admin.cart-enquiry.remark', $cartEnquiry->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <button type="submit" class="btn btn-secondary" style="text-transform: capitalize;" {{ $cartEnquiry->remark === 'read' ? 'disabled' : '' }}>
                                                            {{ $cartEnquiry->remark }}
                                                        </button>
                                                    </form>
                                                </td>
