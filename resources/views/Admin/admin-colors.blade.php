        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link nav-active" href="/admin/colors">
                            <i class="icon-paper menu-icon active-color"></i>
                            <span class="menu-title active-color">Add Colors</span>
                        </a>
                    </li>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="row">
                        <div class="card col-12">
                            <div class="card-body">
                                <h4 class="card-title">Add Product Colors</h4>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $color->color }}</td>
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollEditModal{{ $color->id }}" class="btn btn-success">Edit</button></td>
                                                <td><button data-bs-toggle="modal" data-bs-target="#scrollDeleteModal{{ $color->id }}" class="btn btn-danger">Delete</button></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                ...
                <div class="modal fade" id="scrollAddModal" tabindex="-1" aria-labelledby="scrollAddModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.color.store')}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-header">
                                <h5 class="modal-title" id="scrollAddModalLabel">Add Product Color</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div>
                                    <label for="color" class="form-label">Color Name<span class="text-danger">*</span></label>
                                    <input type="text" name="color" id="color" class="form-control" placeholder="Enter Color Name" required>
                                </div>
                            </div>
                ...
                <!-- Edit Modal -->
                @foreach($colors as $color)
                <div class="modal fade" id="scrollEditModal{{ $color->id }}" tabindex="-1" aria-labelledby="scrollEditModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.color.edit', $color->id)}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-header">
                                <h5 class="modal-title" id="scrollEditModalLabel{{ $color->id }}">Edit Product Color</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div>
                                    <label for="color" class="form-label">Color Name<span class="text-danger">*</span></label>
                                    <input type="text" name="color" id="color" class="form-control" placeholder="Enter Color Name" value="{{ $color->color }}" required>
                ...
                <!-- Delete Modal -->
                @foreach($colors as $color)
                <div class="modal fade" id="scrollDeleteModal{{ $color->id }}" tabindex="-1" aria-labelledby="scrollDeleteModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{route('admin.color.delete', $color->id)}}" method="POST" class="modal-content" enctype="multipart/form-data">
                            @csrf

                            <div class="modal-body">
                                <div>
                                    <h3 class="text-danger" style="text-transform: capitalize;">You want to this {{ $color->color }} Color ?</h3>
                                </div>
                            </div>
                            <div class="modal-footer">
